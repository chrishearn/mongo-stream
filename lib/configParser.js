...
// Omono: commented this out as we use TLS without certs for connection to Mongo Atlas
...
const initOpts = {
  ...
  dumpOnStart: process.env.DUMP_ON_START === 'yes' ? true : false,
};

logger.info(`Dumping on Start: ${process.env.DUMP_ON_START}`);
